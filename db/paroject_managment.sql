...
insert  into `result_tbl`(`result_id`,`group_enrollment_id`,`faculty_id`,`document`,`marks`,`eval_a_m`,`eval_b_m`) values (2,2,1,'Proposal','20','30','32'),(3,2,1,'SRS','28','32','33'),(4,2,NULL,NULL,NULL,'0','0');
...
insert  into `upload_document_tbl`(`up_document_id`,`group_enrollment_id`,`document_name`,`document`,`faculty_id`) values (1,2,'Proposal','maltab.txt',1),(2,2,'SRS','SRS.txt',1),(3,1,'Proposal','maltab.txt',3),(4,1,'SRS','SRS.txt',3);
